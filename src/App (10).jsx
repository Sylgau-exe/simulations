...
const TRANSLATIONS = {
  ...
  landing: {
    ...
    heroTitle1: { en: 'Learn by', fr: 'Apprenez en' },
    heroTitle2: { en: 'Doing', fr: 'Pratiquant' },
    heroSubtitle: { 
      en: 'Master business skills through immersive simulations. Practice project management, strategy, negotiations, and more in risk-free environments.',
      fr: 'Maîtrisez les compétences d\'affaires grâce à des simulations immersives. Pratiquez la gestion de projet, la stratégie et plus encore dans des environnements sans risque.'
    },
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-cta">
            <button className="btn-primary-lg" onClick={() => { setCurrentPage('auth'); setAuthMode('signup'); }}>{t('nav.startFree', lang)} →</button>
            <button className="btn-secondary-lg" onClick={() => setCurrentPage('catalog')}>{t('landing.browseSimulations', lang)}</button>
          </div>
          <div className="hero-stats">
            <div className="stat"><span className="stat-num">6+</span><span className="stat-label">{t('landing.simulations', lang)}</span></div>
            <div className="stat"><span className="stat-num">25+</span><span className="stat-label">{t('landing.scenarios', lang)}</span></div>
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-links">
            <div className="footer-col"><h4>{t('footer.product', lang)}</h4><a href="#">{t('nav.simulations', lang)}</a><a href="#">{t('nav.pricing', lang)}</a><a href="#">{t('footer.forEducators', lang)}</a></div>
      ...
      <div className="dashboard-layout">
        ...
        <main className="dashboard-main">
          <div className="welcome-card">
            <h1>{t('dashboard.welcomeBack', lang)}, {currentUser?.name?.split(' ')[0]}!</h1>
