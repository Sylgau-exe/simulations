    ...
    <div className="app">
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Brief Page - LIGHT THEME for better readability */
        .brief-container { color: #1e293b; }
        .brief-content { 
          background: #ffffff !important; 
          border: 1px solid #e2e8f0 !important; 
        }
        .brief-section p { color: #475569 !important; }
        .brief-section h3 { color: #4f46e5 !important; }
        .mechanics-list { color: #475569 !important; }
        .mechanics-list strong { color: #1e293b; }
        .objectives-grid .objective { 
          background: #f8fafc !important; 
          border: 1px solid #e2e8f0;
        }
        .objective strong { color: #64748b !important; }
        .objective span:last-child { color: #1e293b !important; }
