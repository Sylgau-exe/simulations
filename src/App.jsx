...
// API is in the same Vercel project at /api
const API_BASE = '/api';
    ...
    <div className="app">
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-divider span { padding: 0 1rem; color: var(--text-muted); font-size: 0.875rem; }
        .btn-google { width: 100%; display: flex; align-items: center; justify-content: center; gap: 0.75rem; padding: 0.75rem 1rem; background: white; border: 1px solid var(--border); border-radius: 10px; color: #333; font-family: inherit; font-size: 1rem; font-weight: 500; cursor: pointer; transition: all 0.2s; }
