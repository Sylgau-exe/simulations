                ...
                {userScores.scores.slice(0, 5).map((score, idx) => (
                  <div key={idx} className="score-item">
                    <div className="score-info">
                      <span className="score-scenario">{score.scenario_id}</span>
    ...
    <div className="app">
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Dashboard */
        .dashboard-page { min-height: 100vh; padding-top: 65px; }
        .dashboard-layout { display: flex; max-width: 1400px; margin: 0 auto; }
        .sidebar { width: 280px; padding: 2rem; border-right: 1px solid var(--border); min-height: calc(100vh - 65px); }
        .sidebar-section { margin-bottom: 2rem; }
        .sidebar-section h3 { font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.1em; color: var(--text-muted); margin-bottom: 1rem; }
        .sidebar-btn { width: 100%; padding: 0.85rem 1rem; background: var(--bg-card); border: 1px solid var(--border); border-radius: 10px; color: var(--text-primary); font-size: 0.9rem; text-align: left; margin-bottom: 0.5rem; transition: all 0.2s; }
        .sidebar-btn:hover { border-color: var(--accent-primary); background: var(--bg-elevated); }
        .stat-item { display: flex; justify-content: space-between; padding: 0.75rem 0; border-bottom: 1px solid var(--border); font-size: 0.9rem; }
        .stat-item span { color: var(--text-muted); }
        .stat-item strong { color: var(--text-primary); }
        .dashboard-main { flex: 1; padding: 2rem; }
        .welcome-card { background: linear-gradient(135deg, rgba(99, 102, 241, 0.15) 0%, rgba(139, 92, 246, 0.1) 100%); border: 1px solid rgba(99, 102, 241, 0.3); border-radius: 20px; padding: 2rem; margin-bottom: 2rem; }
        ...
        .score-item { background: var(--bg-card); border: 1px solid var(--border); border-radius: 12px; padding: 1rem; display: flex; justify-content: space-between; align-items: center; }
        .score-scenario { font-weight: 500; }
        .score-date { font-size: 0.85rem; color: var(--text-muted); }
        .score-result { text-align: right; }
        .score-grade { font-size: 1.5rem; font-weight: 700; color: var(--accent-primary); margin-right: 0.75rem; }
        .score-points { color: var(--text-muted); }
        .no-scores { color: var(--text-muted); font-style: italic; }
        .featured-sim-card { background: var(--bg-card); border: 1px solid var(--border); border-radius: 16px; padding: 1.5rem; display: flex; gap: 1.5rem; cursor: pointer; transition: all 0.2s; }
        .featured-sim-card:hover { border-color: var(--accent-primary); }
        .featured-sim-icon { font-size: 2.5rem; background: var(--bg-elevated); padding: 1rem; border-radius: 14px; }
        .featured-sim-content h3 { margin-bottom: 0.25rem; }
        .featured-sim-content p { color: var(--text-muted); font-size: 0.9rem; margin-bottom: 0.5rem; }
        .featured-sim-cta { color: var(--accent-primary); font-size: 0.9rem; font-weight: 500; }
        ...
        .catalog-header h1 { font-size: 2.5rem; margin-bottom: 0.5rem; }
        ...
        .scenario-desc { color: var(--text-muted); font-size: 0.9rem; margin-bottom: 0.5rem; }
        .scenario-badge { display: inline-block; padding: 0.25rem 0.5rem; background: rgba(99, 102, 241, 0.15); border-radius: 4px; font-size: 0.75rem; color: var(--accent-primary); margin-right: 0.5rem; }
        ...
        .mechanics-list { color: var(--text-secondary); padding-left: 1.5rem; margin-top: 0.5rem; }
        ...
        .objective { background: var(--bg-elevated); border-radius: 12px; padding: 1rem; display: flex; flex-direction: column; gap: 0.25rem; text-align: center; }
        .objective span:first-child { font-size: 1.25rem; }
        .objective strong { font-size: 0.7rem; color: var(--text-muted); font-weight: 500; text-transform: uppercase; }
        ...
        /* How to Play Modal */
        .how-to-play-modal { background: var(--bg-card); border: 1px solid var(--border); border-radius: 24px; padding: 2.5rem; max-width: 600px; width: 100%; max-height: 80vh; overflow-y: auto; }
        .how-to-play-modal h2 { margin-bottom: 1.5rem; }
        .how-to-content h3 { color: var(--accent-primary); font-size: 1rem; margin: 1.5rem 0 0.5rem; }
        .how-to-content p, .how-to-content ul { color: var(--text-secondary); font-size: 0.95rem; line-height: 1.7; }
        .how-to-content ul { padding-left: 1.5rem; }
        .how-to-content li { margin-bottom: 0.5rem; }
        
        /* Game Playing */
        .sim-playing { padding: 1.5rem; background: linear-gradient(180deg, var(--bg-primary) 0%, var(--bg-secondary) 100%); min-height: 100vh; }
        ...
        .metric { background: var(--bg-card); border: 1px solid var(--border); border-radius: 14px; padding: 0.85rem; }
        .m-icon { font-size: 1.1rem; display: block; margin-bottom: 0.3rem; }
        .m-label { font-size: 0.65rem; color: var(--text-muted); text-transform: uppercase; display: block; letter-spacing: 0.05em; }
        .m-value { font-family: 'JetBrains Mono', monospace; font-size: 1.1rem; font-weight: 600; }
        .m-bar { height: 4px; background: var(--bg-elevated); border-radius: 2px; margin-top: 0.4rem; overflow: hidden; }
        ...
        .game-actions > h3 { font-size: 1.1rem; margin-bottom: 1.25rem; color: var(--accent-primary); }
        .action-section { margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px solid var(--border); }
        .action-section h4 { font-size: 0.85rem; color: var(--text-secondary); margin-bottom: 0.75rem; }
        ...
        .meeting-btn { background: var(--bg-elevated); border: 1px solid var(--border); border-radius: 12px; padding: 1rem; text-align: left; cursor: pointer; transition: all 0.2s; display: flex; flex-direction: column; gap: 0.25rem; }
        .meeting-btn:hover:not(:disabled) { border-color: var(--accent-primary); background: rgba(99, 102, 241, 0.1); }
        .meeting-btn.active { border-color: var(--success); background: rgba(16, 185, 129, 0.1); }
        .meeting-btn:disabled { opacity: 0.6; cursor: default; }
        .meeting-icon { font-size: 1.5rem; }
        .meeting-name { font-weight: 600; font-size: 0.85rem; }
        .meeting-desc { font-size: 0.75rem; color: var(--text-muted); line-height: 1.4; }
        .meeting-done { color: var(--success); font-size: 0.75rem; font-weight: 600; margin-top: 0.25rem; }
        
        /* Quick Actions */
        .quick-actions { display: flex; gap: 0.75rem; flex-wrap: wrap; }
        .quick-btn { padding: 0.75rem 1.25rem; background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.25); border-radius: 10px; color: #6ee7b7; font-family: inherit; cursor: pointer; transition: all 0.2s; font-size: 0.9rem; }
        .quick-btn:hover:not(:disabled) { background: rgba(16, 185, 129, 0.2); }
        .quick-btn:disabled { opacity: 0.4; cursor: not-allowed; }
        .quick-btn.crunch { background: rgba(239, 68, 68, 0.1); border-color: rgba(239, 68, 68, 0.25); color: #fca5a5; }
        .quick-btn.crunch:hover { background: rgba(239, 68, 68, 0.2); }
